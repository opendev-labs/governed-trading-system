...
const faqs = [
    {
        ...
        answer: "No. ScanTrade is strictly a screening and alert system. It identifies potential setups based on your logic but it never places orders on your behalf."
    },
    {
    ...
    },
    {
        ...
        answer: "No. ScanTrade does not require API keys for your broker or exchange. It reads market data and sends messages to Discord. Your funds are never touched."
    },
    {
