...
const screenerCatalog: Screener[] = [
    {
        id: "vwap-breakout",
        title: "VWAP Breakout Engine",
        description: "Institutional momentum scanner. Detects high-volume price crosses above VWAP with rising CVD.",
    ...
    {
        id: "liquidity-sweep",
        title: "Liquidity Sweep Hunter",
        description: "Identifies 'Stop Hunt' patterns where price pierces key Swing Highs/Lows before reversing.",
    ...
    {
        id: "rsi-divergence",
        title: "RSI Divergence AI",
        description: "Advanced reversal detection. Spots discrepancies between Price action and RSI momentum.",
    ...
    {
        id: "ict-killzone",
        title: "ICT Killzone Sniper",
        description: "Time-based algorithmic entry model for London and New York sessions.",
    ...
    {
        id: "volume-imbalance",
        title: "Volume Imbalance (FVG)",
        description: "Scans for Fair Value Gaps and aggressive buying/selling pressure imbalances.",
    ...
    },
    {
        ...
        title: "Trend Flow Pro",
        description: "Multi-timeframe EMA alignment scanner designed to catch pullbacks in trends.",
...
export default function Screeners() {
    ...
    // Load state
    useEffect(() => {
        const saved = localStorage.getItem("scantrade_active_screeners")
        if (saved) {
    ...
    const toggleScreener = (id: string) => {
        ...
        localStorage.setItem("scantrade_active_screeners", JSON.stringify(newActive))
    }
